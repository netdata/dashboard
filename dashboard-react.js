...
NETDATA.themes = {
  white: {
    ...
    easypiechart_track: "#ECEFF2",
    easypiechart_scale: "#F7F8F8",
    gauge_pointer: "#93A3B0",
    gauge_stroke: "#ECEFF2",
    gauge_gradient: false,
    gauge_stop_color: "#FF4C00",
    gauge_start_color: "#FF4C00",
    d3pie: {
      title: "#333333",
      subtitle: "#666666",
      footer: "#888888",
  ...
  slate: {
    ...
    easypiechart_track: "#383B40",
    easypiechart_scale: "#24292F",
    gauge_pointer: "#878b90",
    gauge_stroke: "#383B40",
    gauge_gradient: false,
    gauge_stop_color: "#FF4C00",
    gauge_start_color: "#FF4C00",
