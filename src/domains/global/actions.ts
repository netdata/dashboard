...
export const setFreezeChartsAction = createAction(`${storeKey}/setFreezeChartsAction`)
export const resetGlobalPauseAction = createAction(`${storeKey}/resetGlobalPauseAction`)
